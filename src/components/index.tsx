    ...
    return (
        <main className="flex flex-col justify-between w-full h-full p-5 lg:pl-60 lg:pr-60">
            <div className="w-full h-4/5 pl-20 pr-20 text-white">
                <div className="w-full 2xl:h-[calc(60vh-4rem)] bg-green-900 rounded-2xl flex p-16 pl-12 pr-12">
                    <div className="w-3/6 flex flex-col items-start justify-center">
                        ...
                        with freelancer all over the world</p>
                        <div className="relative items-center w-full lg:flex hidden md:flex mt-8 mb-16">
                            <input
                                type="text"
